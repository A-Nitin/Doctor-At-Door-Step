...
public class forgetPassword extends javax.swing.JFrame {
    ...
    private void btn2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn2MouseClicked
        try{
            ...
            ps = conn.prepareStatement("update otp_doc set code =\""+formatted+"\" where username=\""+username+"\"");
            ps.executeUpdate();

            respondMsg.setText("New otp is sent to your mail.");
            
            ps = conn.prepareStatement("select email from doctors where username=\""+username+"\"");
            rs = ps.executeQuery();
            rs.next();
    ...
    private void btn1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn1MouseClicked
        try {
            if(label1.getText().equals("Otp:")){
                ps = conn.prepareStatement("select * from otp_doc where username =\""+username+"\" and code=\""+field1.getText()+"\"");
                rs = ps.executeQuery();
                if(rs.next()){
            ...
            else if(label1.getText().equals("Email:"))
            {
                ...
                {
                    ps = conn.prepareStatement("select * from doctors where email=\""+field1.getText()+"\"");
                    rs = ps.executeQuery();
                    if(rs.next()){
                        Random rand = new Random();
                        int pin = rand.nextInt(10000);
                        ...
                        ps = conn.prepareStatement("select * from otp_doc where username=\""+username+"\"");
                        rs = ps.executeQuery();
                        ...
                        {
                            ps = conn.prepareStatement("insert into otp_doc (username,code) values (\""+username+"\",\""+formatted+"\")");
                            ps.executeUpdate();
                        }
    ...
    private void btnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnMouseClicked
        ...
        else
        {
            try 
            {
                ...
                {
                ps = conn.prepareStatement("update doctors set password=? where username=?");
