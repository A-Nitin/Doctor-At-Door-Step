...
public class Main extends javax.swing.JFrame {
    ...
    void clearAll(){
        ...
        errorMsg.setText("");
        specialText.setText("Specialist In");
    }
    ...
    private void initComponents() {
        ...
        specialPanel.setBackground(new java.awt.Color(255, 232, 232));

        specialText.setBackground(new java.awt.Color(255, 232, 232));
        specialText.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        specialText.setForeground(new java.awt.Color(102, 102, 102));
        specialText.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        specialText.setText("Specialitst In");
        specialText.setBorder(null);
        specialText.setOpaque(false);
        specialText.setPreferredSize(new java.awt.Dimension(51, 20));
        ...
        specialPanelLayout.setHorizontalGroup(
            ...
            .addGroup(specialPanelLayout.createSequentialGroup()
                .addGap(18, 18, 18)
                .addComponent(specialText, javax.swing.GroupLayout.PREFERRED_SIZE, 196, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        specialPanelLayout.setVerticalGroup(
            specialPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, specialPanelLayout.createSequentialGroup()
                .addComponent(specialText, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );

        forget.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        forget.setForeground(new java.awt.Color(51, 51, 51));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(specialPanel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btnLabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLabelMouseClicked
        if(btnLabel.getText().equals("Sign In")){
            ...
            if(userText.getText().equals("")||passText.getText().equals("")||lastText.getText().equals("")||phoneText.getText().equals("")||firstText.getText().equals("")||emailText.getText().equals("")||specialText.getText().equals("")
            ||userText.getText().equals("Username")||passText.getText().equals("Password")||lastText.getText().equals("Last")||phoneText.getText().equals("Phone No")||firstText.getText().equals("First")||emailText.getText().equals("Email Id")||specialText.getText().equals("Specialist In"))
                ...
                try{
                    if (conn != null) {
                        stmt=conn.prepareStatement("select * from doctors where name=?");
                        ...
                        {
                            stmt=conn.prepareStatement("select * from doctors where username=?");
                            stmt.setString(1,username);
                            rs = stmt.executeQuery();              
                            ...
                            else 
                            {
                                if(phone.length()==10)
                                {
                                    if(email.indexOf("@gmail.com")>5){
                                        stmt=conn.prepareStatement("select * from doctors where email=?");
                                        ...
                                        {
                                            stmt=conn.prepareStatement("insert into doctors(username,password,name,special,phone_no,email,status) values (?,?,?,?,?,?,?)");
                                            stmt.setString(1,username);
                                    ...
                                    else  errorMsg.setText("Invalid email id");
                                }
                                else
                                {
    ...
    private void specialTextFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_specialTextFocusGained
        if(specialText.getText().equals("Specialist In"))
            specialText.setText("");
